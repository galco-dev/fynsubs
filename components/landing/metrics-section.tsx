          ...
          {metrics.map((metric, index) => (
            ...
            >
              {"isText" in metric && metric.isText ? (
                <div className="text-6xl lg:text-8xl font-display tracking-tight">{metric.prefix}</div>
              ) : (
                <AnimatedCounter 
              ...
              {"source" in metric && (
                <div className="mt-1 text-xs font-mono text-muted-foreground/60">{metric.source}</div>
              )}
            </div>
          ))}
        </div>
