...
const securityFeatures = [
  {
    ...
    description: "Every site runs on Cloudflare's SOC 2-certified infrastructure.",
  },
  {
    icon: Lock,
    title: "End-to-end encryption",
    description: "Every hosted site served over TLS 1.3, automatic certificate renewal.",
  },
  {
    icon: Eye,
    title: "DDoS protection",
    description: "Automatic mitigation at the network edge. Sites stay online under attack.",
  },
  {
    icon: FileCheck,
    title: "Payments by Stripe",
    description: "Activation runs through Stripe, PCI-DSS Level 1. Card details never touch Fyn.",
  },
];

const certifications = ["PCI-DSS", "TLS 1.3", "GDPR", "SOC 2", "DDoS Protected"];
